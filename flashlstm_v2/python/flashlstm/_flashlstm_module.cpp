...
PyMethodDef ModuleMethods[] = {
    ...
    {"lstm_forward", LstmForward, METH_VARARGS, "Invoke the device-resident LSTM forward pass."},
    {"lstm_backward", LstmBackward, METH_VARARGS, "Invoke the device-resident LSTM backward pass."},
