...
PyObject *StreamingLstmForward(PyObject *, PyObject *args) {
    ...
    flstm_GateCacheHost gate_cache_host{
        .h_ptr = PtrFromUnsigned<void *>(gate_cache_h_host),
        .c_ptr = PtrFromUnsigned<void *>(gate_cache_c_host),
    };
...
PyObject *LstmForward(PyObject *, PyObject *args) {
    unsigned long long time_steps{};
    unsigned long long batch_size{};
    unsigned long long input_size{};
    unsigned long long hidden_size{};
    unsigned long long recompute_interval{};
    unsigned long long weight_set_count{};
    unsigned long long x_tensor_device{};
    unsigned long long h0_device{};
    unsigned long long c0_device{};
    unsigned long long weights_ih{};
    unsigned long long weights_hh{};
    unsigned long long bias_ih{};
    unsigned long long bias_hh{};
    unsigned long long y_tensor_device{};
    unsigned long long gate_cache_h_device{};
    unsigned long long gate_cache_c_device{};
    unsigned long long gate_cache_h_dtype{};
    unsigned long long gate_cache_c_dtype{};
    unsigned long long time_oversample{};
    unsigned long long hy_device{};
    ...
    flstm_GateCacheHost gate_cache_dev{
        .h_ptr = PtrFromUnsigned<void *>(gate_cache_h_device),
        .c_ptr = PtrFromUnsigned<void *>(gate_cache_c_device),
    };
    flstm_StreamingLstmOptions options{};
    options.h_dtype = static_cast<flstm_GateCacheDType>(gate_cache_h_dtype);
    options.c_dtype = static_cast<flstm_GateCacheDType>(gate_cache_c_dtype);
    ...
    flstm_LstmForward(
        ...
        static_cast<size_t>(recompute_interval),
        static_cast<size_t>(weight_set_count),
        PtrFromUnsigned<const __half *>(x_tensor_device),
        PtrFromUnsigned<const __half *>(h0_device),
        PtrFromUnsigned<const __half *>(c0_device),
        PtrFromUnsigned<const float *>(weights_ih),
        PtrFromUnsigned<const float *>(weights_hh),
        PtrFromUnsigned<const float *>(bias_ih),
        PtrFromUnsigned<const float *>(bias_hh),
        PtrFromUnsigned<__half *>(y_tensor_device),
        gate_cache_dev,
        &options,
        PtrFromUnsigned<__half *>(hy_device),
        PtrFromUnsigned<__half *>(cy_device),
...
PyObject *LstmBackward(PyObject *, PyObject *args) {
    unsigned long long time_steps{};
    unsigned long long batch_size{};
    unsigned long long input_size{};
    unsigned long long hidden_size{};
    ...
    unsigned long long gate_cache_c_dtype{};
    unsigned long long time_oversample{};
    unsigned long long dY_tensor_device{};
    unsigned long long d_hn_device{};
    unsigned long long d_cn_device{};
    unsigned long long h0_device{};
    unsigned long long c0_device{};
    ...
    unsigned long long bias_ih{};
    unsigned long long bias_hh{};
    unsigned long long dx_tensor_device{};
    unsigned long long dW_ih{};
    unsigned long long dW_hh{};
    unsigned long long db_ih{};
    unsigned long long db_hh{};
    ...
    flstm_LstmBackward(
        ...
        static_cast<size_t>(weight_set_count),
        PtrFromUnsigned<const __half *>(x_tensor_device),
        PtrFromUnsigned<const __half *>(y_tensor_device),
        gate_cache_dev,
        PtrFromUnsigned<const __half *>(dY_tensor_device),
        PtrFromUnsigned<const __half *>(d_hn_device),
        PtrFromUnsigned<const __half *>(d_cn_device),
        PtrFromUnsigned<const __half *>(h0_device),
        PtrFromUnsigned<const __half *>(c0_device),
        ...
        PtrFromUnsigned<const float *>(bias_ih),
        PtrFromUnsigned<const float *>(bias_hh),
        PtrFromUnsigned<__half *>(dx_tensor_device),
        PtrFromUnsigned<float *>(dW_ih),
        PtrFromUnsigned<float *>(dW_hh),
        PtrFromUnsigned<float *>(db_ih),
        PtrFromUnsigned<float *>(db_hh),
...
PyMethodDef ModuleMethods[] = {
    ...
    {"lstm_forward", LstmForward, METH_VARARGS, "Invoke the device LSTM forward pass."},
    {"lstm_backward", LstmBackward, METH_VARARGS, "Invoke the device LSTM backward pass."},
